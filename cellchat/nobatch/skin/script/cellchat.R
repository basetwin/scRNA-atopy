...
for (name in names(objlist)) {
	...
	saveRDS(cellchat, paste0('/home2/sbjs0428/R/atopyNK/cellchat/nobatch/skin/data/',name, '_cellchat.RDS'))
}


at <- readRDS('/home2/sbjs0428/R/atopyNK/cellchat/nobatch/skin/data/ATSK_cellchat.RDS')
atx <- readRDS('/home2/sbjs0428/R/atopyNK/cellchat/nobatch/skin/data/ATSKTX_cellchat.RDS')
object.list <- list('ATSK' = at, 'ATSKTX' = atx)
saveRDS(object.list, '/home2/sbjs0428/R/atopyNK/cellchat/nobatch/skin/data/objlist.RDS')
