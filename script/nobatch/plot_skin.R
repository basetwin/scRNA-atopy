...
plot <- volcano(deg, title_ = 'DEGs between ATSKTX and ATSK', ylim=c(0,300))
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/volcano/skin_ATSKTX_ATSK_volcano_8x10.png', plot, width=8, height=10, dpi=1200, units='in')

deg <- FindMarkers(obj, group.by='Type', ident.1='NSK', ident.2	='ATSK')
plot <- volcano(deg, title_ = 'DEGs between NSK and ATSK')
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/volcano/skin_NSK_ATSK_volcano_8x10.png', plot, width=8, height=10, dpi=1200, units='in')
...
png('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/heatmap/celltype_markers_heatmap_12x9.png', width=12, height=9, res=1200, units='in')
dittoHeatmap(obj, genes, annot.by='celltype', scaled.to.max=F, cluster_rows=F, annot.colors=skin_colors, heatmap.colors=colorRampPalette(c('white', 'red'))(30), slot='counts', scale='none', breaks=c(0:30), complex=F)
dev.off()



kera_markers <- c('Lgr5','Elovl5', 'Acsbg1', 'Far2', 'Acot5', 'Pnpla5', 'Krt14', 'Krt5', 'Krt15', 'Krt1', 'Krt10', 'Krt6a','Krt16', 'Krt79', 'S100a8', 'S100a9','Flg', 'Lor')

kera <- subset(obj, celltype %in% levels(obj$celltype)[1:10])
kera$celltype <- factor(kera$celltype, levels=c(as.vector(levels(obj$celltype)[1:10])))

png('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_kera_dimplot_12x10.png', width=12, height=10, res=1200, units='in')
dittoDimPlot(kera, 'celltype')
dev.off()


png('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_dimplot_13x10.png', width=13, height=10, res=1200, units='in')
dittoDimPlot(obj, 'celltype')
dev.off()
...
#/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/
png('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/heatmap/keratinocyte_markers_heatmap_12x9.png', width=12, height=9, res=1200, units='in')
...
png('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_kera_dotplot_8x10.png', width=8, height=10, res=1200, units='in')
dittoDotPlot(kera,  c('Lgr5','Elovl5', 'Acsbg1', 'Far2', 'Acot5', 'Pnpla5', 'Krt14', 'Krt5', 'Krt15', 'Krt1', 'Krt10', 'Krt6a','Krt16', 'Krt79', 'Flg', 'Lor')
, group.by='celltype')
dev.off()



png('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_barplot_8x10.png', width=8, height=10, res=1200, units='in')
dittoBarPlot(obj, 'celltype', group.by='Type', retain.factor.levels=T)
dev.off()



source('/home2/sbjs0428/R/atopyNK/script/nobatch/subsampling.R')
obj <- subsampling()
png('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_barplot_bulgenormalized_8x10.png', width=8, height=10, res=1200, units='in')
dittoBarPlot(obj, 'celltype', group.by='Type', retain.factor.levels=T)
dev.off()

png('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_barplot_bulgenormalized_count_8x10.png', width=8, height=10, res=1200, units='in')
dittoBarPlot(obj, 'celltype', group.by='Type', retain.factor.levels=T, scale='count')
dev.off()


plist <- list()
plist[[1]] <- dittoDimPlot(obj, 'celltype', main='All samples', legend.show=F)
...
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_dimplot_all-nsk-atsk-atsktx_10x10.png',all_plots, height=10, width=10, dpi=1200, units='in')
...
cds <- trajectory(kera, rootcell= 9)
plot <- pseudo_boxplot(temp_cds)
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_kera_pseudotime_boxplot_8x10.png', plot, height=10, width=8, dpi=1200, units='in')



for (type in unique(kera$Type)) {
	temp_obj <- subset(kera, Type == type)
	temp_cds <- trajectory(temp_obj, 9)
	plot <- pseudo_boxplot(temp_cds)
	ggsave(paste0('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_kera_', type, '_pseudotime_boxplot_8x10.png'), plot, height=10, width=8, dpi=1200, units='in')
}
...
temp_cds <- trajectory(kera, 9)
plot <- pseudo_boxplot(temp_cds, celltype_colors = skin_colors, plot_title = 'Whole keratinocytes pseudotime boxplot')
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_kera_revised_pseudotime_boxplot_8x10.png', plot, height=10, width=8, dpi=1200, units='in')

for (type in unique(kera$Type)) {
        temp_obj <- subset(kera, Type == type)
        temp_cds <- trajectory(temp_obj, 9)
        plot <- pseudo_boxplot(temp_cds, celltype_colors = skin_colors, plot_title = paste0(type, ' pseudotime boxplot'))
        ggsave(paste0('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_kera_', type, '_revised_pseudotime_boxplot_8x10.png'), plot, height=10, width=8, dpi=1200, units='in')
}
...
for (type in unique(kera$Type)) {
        ...
        ggsave(paste0('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_kera_', type, '_pseudo_10x10.png'), plot, height=10, width=10, dpi=1200, units='in')
	temp_obj$pseudotime <- pseudotime(temp_cds)
	plot <- FeaturePlot(temp_obj, 'pseudotime')
	ggsave(paste0('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_kera_', type, '_pseudo_featureplot_10x10.png'), plot, height=10, width=10, dpi=1200, units='in')
}

kera$pseudotime <- pseudotime(cds_kera)
plot <- FeaturePlot(kera, 'pseudotime')
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_kera_pseudo_featureplot_10x10.png', plot, height=10, width=10, dpi=1200, units='in')
...
patterns <- "regeneration|inflam|leuko|cytokine|chemokine|wound|immune|skin|epithe|interferon|macrophage|T cell|kera|NK|interleukin|MHC|lympho|epidermal|natural killer|neutrophil|stimulus|potassium|chemotaxis|migration|infiltration"




############# Adipocyte ######################
#/home2/sbjs0428/R/atopyNK/ontology_output/nobatch/skin
...
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/volcano/skin_adipo_volcano_8x10.png', plot, width=8, height=10, dpi=1200, units='in')
...
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/heatmap/adipo_markers_heatmap_10x13.png',plot, width=10, height=13, dpi=1200, units='in') 

adipo_gse <- ontology(adipo_deg, organism='mouse', num=15, title='Adipocyte DEGs', category.size=12, data.out=T)@result
adipo_gse_filtered <- ontology(adipo_deg_filtered, organism='mouse', num=15, data.out=T, patterns=patterns)
write.xlsx(adipo_gse_filtered@result, '/home2/sbjs0428/R/atopyNK/ontology_output/nobatch/skin/adipo_ontology_output.xlsx', asTable=T)
...
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_adipo_ontology_filtered_10x13.png',plot, width=10, height=13, dpi=1200, units='in')
...
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/heatmap/adipo_markers_ontologyfiltered_heatmap_10x13.png',plot, width=10, height=13, dpi=1200, units='in')
...
plot <- volcano(fibro_deg, 'Fibroblast DEGs between ATSKTX and ATSK', ylim=c(0,120))
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/volcano/skin_fibro_volcano_8x10.png', plot, width=8, height=10, dpi=1200, units='in')
...
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/heatmap/fibro_markers_heatmap_10x13.png',plot, width=10, height=13, dpi=1200, units='in')
fibro_gse <- ontology(fibro_deg, organism='mouse', num=12, title='Fibroblast DEGs', category.size=12, data.out=T)@result
...
write.xlsx(fibro_gse_filtered@result, '/home2/sbjs0428/R/atopyNK/ontology_output/nobatch/skin/fibro_ontology_output.xlsx', asTable=T)
...
plot <- only_plot_ontology(fibro_gse_filtered, num=30, title='Fibroblast DEGs filtered', category.size=9)
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_fibro_ontology_filtered_10x15.png', plot, width=10, height=15, dpi=1200, units='in')
...
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/heatmap/fibro_markers_ontologyfiltered_heatmap_10x13.png',plot, width=10, height=13, dpi=1200, units='in')
...
plot <- volcano(kera_deg, 'Keratinocyte DEGs between ATSKTX and ATSK', ylim=c(0.120))
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/volcano/skin_kera_volcano_8x10.png', plot, width=8, height=10, dpi=1200, units='in')

kera_deg_filtered <- kera_deg %>% filter(p_val_adj < 0.05, abs(avg_log2FC) > 0.6) # %>% arrange(p_val_adj) %>% slice_head(n=100)
if (nrow(kera_deg_filtered) > 100) {
        kera_deg_100 <- kera_deg_filtered %>% arrange(desc(abs(pct.1-pct.2))) %>% slice_head(n=100)
        plot <- dittoHeatmap(kera, rownames(kera_deg_100), annot.by=c('celltype', 'Type'), order.by='Type', scaled.to.max=T, annot.colors=c("#CC79A7", '#00BE67', "#377EB8", "#E41A1C"))
} else {
        plot <- dittoHeatmap(kera, rownames(kera_deg_filtered), annot.by=c('celltype', 'Type'), order.by='Type', scaled.to.max=T, annot.colors=c("#CC79A7", '#00BE67', "#377EB8", "#E41A1C"))
}
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/heatmap/kera_markers_heatmap_10x13.png',plot, width=10, height=13, dpi=1200, units='in')
...
write.xlsx(kera_gse_filtered@result, '/home2/sbjs0428/R/atopyNK/ontology_output/nobatch/skin/kera_ontology_output.xlsx', asTable=T)
...
plot <- only_plot_ontology(kera_gse_filtered, num=30, title='Keratinocyte DEGs filtered', category.size=9)
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/skin_kera_ontology_filtered_10x16.png',plot, width=10, height=16, dpi=1200, units='in')


plot <- dittoHeatmap(kera, kera_genes, annot.by=c('celltype', 'Type'), order.by='Type', scaled.to.max = T, annot.colors=c("#CC79A7", '#00BE67', "#377EB8", "#E41A1C"))
ggsave('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/heatmap/kera_markers_ontologyfiltered_heatmap_10x15.png',plot, width=10, height=15, dpi=1200, units='in')


########### T cell subtypes #####################

tcells <- subset(obj, celltype %in% levels(obj$celltype)[c(18,19,21)])

tcells <- levels(obj$celltype)[c(18,19,21)]
...
for (t in tcells) {
	...
	ggsave(paste0('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/heatmap/', t, '_markers_heatmap_10x13.png'), plot, widt=10, height=13, dpi=1200, units='in')
}
...
keras <- levels(obj$celltype)[c(1,7,8,9,10)]

for (k in keras) {
    temp <- subset(obj, celltype == k)
    temp$celltype <- factor(temp$celltype, levels = k)

    deg_filtered <- FindMarkers(temp, group.by='Type', ident.1='ATSKTX', ident.2='ATSK') %>% 
                    filter(p_val_adj < 0.05, abs(avg_log2FC) > 0.6)

    if (nrow(deg_filtered) > 0) {
	if (nrow(deg_filtered) > 100) {
		deg_filtered <- deg_filtered %>% arrange(desc(abs(pct.1-pct.2))) %>% slice_head(n=100)
	}
        plot <- dittoHeatmap(temp, rownames(deg_filtered), annot.by=c('celltype', 'Type'), order.by='Type', scaled.to.max=TRUE, 
                             annot.colors = c(skin_colors[[k]], '#00BE67', "#377EB8", "#E41A1C"))
        ggsave(paste0('/home2/sbjs0428/R/atopyNK/plots/nobatch/skin/heatmap/', k, '_markers_heatmap_10x13.png'), 
               plot, width=10, height=13, dpi=1200, units='in')
    }}
